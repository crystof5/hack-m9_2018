        ...
        <div class="row contact-form-design-area">
            ...
            <div class="col-md-6 contact-details-list">
                ...
                <div class="single-contact">
                    <h3><i class="fa fa-map"></i>3800 rue Sherbrooke Est<br>Montreal, Quebec, Canada<br>H1X2A2</h3>
                </div>
                <div class="single-contact">
                    <h3><i class="fa fa-phone"></i>+15142547131</h3>
                </div>
                <div class="single-contact">
                  <h3> <i class="fa fa-envelope"></i>info@dolphlife.com</h3>
                </div>
