...
?>
    ...
    <header id="home" class="welcome-area">
                            ...
                            <div class="navbar navbar-nobg">
                                ...
                                <div class="navbar-collapse collapse">
                                    <ul class="nav navbar-nav navbar-right">
                                        ...
                                        <li><a class="smoth-scroll" href="#prices">prices</a>
                                        </li>
        ...
        <div class="welcome-video-area">
            <a class="player" data-property="{videoURL:'https://www.youtube.com/watch?v=LStXdttFj_o',containment:'#home', showControls:false, autoPlay:true, zoom:0, loop:true, mute:false, startAt:0, opacity:1, quality:'default'}"></a>
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <div class="about-text">
                        <h2 class="wow fadeInDown" data-wow-delay=".2s">We are commercially driven and focus on excellence with impact.</h2>
                        <p class="wow fadeInDown" data-wow-delay=".4s">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page.</p>
                        <p class="wow fadeInDown" data-wow-delay=".4s">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters.</p>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="call-to-area-text text-center">
                        ...
                        <a class="Agenda-scroll" href="#appoinment">contact us</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="team-list">
                ...
                <div class="single-team">
                    <div class="team-image">
                        <img src="assets/images/team/team1.jpg" alt="" class="img-responsive">
                    </div>
                ...
                <div class="single-team">
                    <div class="team-image">
                        <img src="assets/images/team/team2.jpg" alt="" class="img-responsive">
                    </div>
                    <div class="team-description">
                        <h4>jonathon doe</h4>
                        <p>user interface desiger</p>
                ...
                <div class="single-team">
                    <div class="team-image">
                        <img src="assets/images/team/team3.jpg" alt="" class="img-responsive">
                    </div>
                    <div class="team-description">
                        <h4>jonathon doe</h4>
                        <p>user interface desiger</p>
                ...
                <div class="single-team">
                    <div class="team-image">
                        <img src="assets/images/team/team4.jpg" alt="" class="img-responsive">
                    </div>
                    <div class="team-description">
                        <h4>jonathon doe</h4>
                        <p>user interface desiger</p>
    ...
    <section id="prices" class="pricing-area section-padding">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-delay=".2s">
                    <div class="pricing-box">
                        ...
                        <ul class="list-unstyled plan-features">
                            <li><span>1 GB</span> of space</li>
                            <li><span>Unlimited</span> traffic</li>
                            <li>Forum access</li>
                            <li>Support at <span>24/hour</span></li>
                            <li>lifetime<span> access</span></li>
                            <li>free<span> airtime</span></li>
                        </ul>
                        <a class="plan-more hvr-sweep-to-top" href="">buy now</a>
                    </div>
                </div>
                ...
                <!-- / END SINGLE PRICING DESIGN AREA -->
                <!-- START SINGLE PRICING DESIGN AREA -->
                <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-delay=".6s">
                    <div class="pricing-box">
                        <div class="pricing-header">
                            <div class="plan-title">
                                <h4>advance</h4>
                ...
                <div class="col-md-12">
                    <div class="blog-list">
                        ...
                        <div class="single-blog">
                            ...
                            <h2><a href="blog.html">Create website step by step</a></h2>
                            <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. </p>
                            <h5>5 february 2017</h5>
                            <a class="comment-link" href=""><i class="fa fa-comment"></i></a>
                        </div>
    ...
    <!-- ANY QUESTIONS  DESIGN AREA -->
    <section id="faq" class="any-questions-area section-padding">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="section-title">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="qustion-image">
                        <img src="assets/images/about.jpg" alt="">
                    </div>
                </div>
                <div class="col-md-6 any-qustions-design">
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab" id="headingOne">
                                <h4 class="panel-title">
        						<a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
          							 What is Agenda agency?
        						</a>
      						</h4>
                            </div>
    ...
    <section class="call-to-action-small-area section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h2>Agenda - One Page MultiPurpose Template</h2>
                </div>
                <div class="col-md-4">
                    <div class="call-to-action-small-button">
                        <a href="" class="call-to-more">purchase now</a>
                    </div>
                </div>
            </div>
        </div>
